...
* [Risk Neutral Valuation](https://en.wikipedia.org/wiki/Risk-neutral_measure). The process by which options and other derivatives are priced by treating investors as though they were risk neutral (insensitive to risk).
...
* [Volatility Skew/Smile](https://en.wikipedia.org/wiki/Volatility_smile). The phenomena of options' implied volatilities varying with strike price.
